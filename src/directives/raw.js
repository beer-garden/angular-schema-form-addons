  ...
  return {
    ...
    link: function(scope, element, attrs, ngModel) {
      ...
      function parseSuccessfulOrEmpty(value) {
        return ['object', 'number', 'boolean'].indexOf(typeof value) !== -1 || value === null || value === undefined;
      }
      ...
      ngModel.$validators['badType'] = function(modelValue, viewValue) {
        return parseSuccessfulOrEmpty(modelValue) ||
            viewValue.startsWith('{') ||
            viewValue.startsWith('[') ||
            (viewValue.startsWith('"') && viewValue.endsWith('"') && viewValue.length > 1);
      };
